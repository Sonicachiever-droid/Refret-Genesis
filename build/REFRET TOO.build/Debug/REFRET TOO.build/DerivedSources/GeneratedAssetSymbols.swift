...
extension DeveloperToolsSupport.ImageResource {
    ...
    static let VUSET = DeveloperToolsSupport.ImageResource(name: "VUSET", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "VUSET" asset catalog image.
    static var VUSET: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .VUSET)
#else
        .init()
...
extension UIKit.UIImage {
    ...
    /// The "VUSET" asset catalog image.
    static var VUSET: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .VUSET)
#else
        .init()
